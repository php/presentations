window["render_moodlebench"] = function() {
    $('#moodlebench_container').highcharts({
        ...
        series: [{
            name: 'r/s @ 10',
			yAxis: 0,
            data: [210.14,209.84,218.08,412.07],
            dataLabels: {
                enabled: true,
                rotation: -90,
                color: '#000',
            ...
            name: 'r/s @ 20',
			yAxis: 0,
            data: [210.14,214.24,215.74,415.18],
            dataLabels: {
                enabled: true,
                rotation: -90,
                color: '#fff',
            ...
            name: 'r/s @ 40',
			yAxis: 0,
            data: [210.87,213.94,218.28,416.08],
            dataLabels: {
                enabled: true,
                rotation: -90,
                color: '#000',
