window["render_opencartbench"] = function() {
    $('#opencartbench_container').highcharts({
        ...
        series: [{
            name: 'r/s @ 10',
			yAxis: 0,
            data: [264.18,273.15,275.38,278.55,308.87,283.02],
            dataLabels: {
                enabled: true,
                rotation: -90,
                color: '#000',
            ...
            name: 'r/s @ 20',
			yAxis: 0,
            data: [265.28,275.58,277.35,281.15,312.24,280.73],
            dataLabels: {
                enabled: true,
                rotation: -90,
                color: '#fff',
            ...
            name: 'r/s @ 40',
			yAxis: 0,
            data: [265.31,275.72,277.18,280.95,311.31,280.12],
            dataLabels: {
                enabled: true,
                rotation: -90,
                color: '#000',
            ...
            name: 'latency @ 10',
			yAxis: 1,
			data: [38.1,36.6,36.4,36,32.5,35.4],
            ...
            name: 'latency @ 20',
			yAxis: 1,
			data: [75.3,72.9,72.1,71.9,64.1,71.3],
			tooltip: { valueSuffix: 'ms' },
            dataLabels: {
                enabled: true,
                rotation: -90,
            ...
            name: 'latency @ 40',
			yAxis: 1,
			data: [150.7,145.2,144.2,142.5,128.2,142.5],
			tooltip: { valueSuffix: 'ms' },
            dataLabels: {
                enabled: true,
                rotation: -90,
